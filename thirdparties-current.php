...
<!--jumbotron-->
<div class="jumbotron jumbotron-fluid d-flex flex-column justify-content-center align-items-center text-center text-light bg--thirdparties-banner min-500 p-5 mb-0 scene_element scene_element--fadeindown">
    <img class="jaxx-logo-text mt-5 pt-5 mb-0 scene_element scene_element--zoomin scene_element--delayed" src="/assets/img/JaxxLiberty_Logo_RGB_Screen%20(white%20Liberty%20white%20X).svg" alt="Jaxx Liberty">
    <h1 class="page-title font-weight-bold pb-3 pt-2 scene_element scene_element--fadeinup scene_element--delayed">Third Party Agreements</h1>
    <hr class="hr-big border-0 bg-orange scene_element scene_element--fadeinleft scene_element--delayed">
                     
</div>
<!--container-->
<div class="container-fluid bg-white py-4 px-3 scene_element scene_element--fadeinup">
    <div id="thirdPartyIntegrations" class="col-sm-12 font-weight-light p-4">
        ...
        <div class="table-responsive-sm mt-4 shadow-lg">
