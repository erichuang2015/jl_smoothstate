...
<div role="banner" class="container-fluid scene_element scene_element--fadein">
...
<!--security-->
    ...
    <div class="row d-flex justify-content-center aligh-items-center min-400 bg-light m-3 p-5 rounded shadow-lg">
    ...
    <div class="row d-flex bg-white m-3 min-500 rounded shadow-lg">
   ...
   <div class="card-deck">
     <div class="card shadow-lg text-secondary mx-2">
      ...
      <div class="card shadow-lg text-secondary mx-2">
        <img class="card-img-top" src="/assets/img/jaxx-home-banner.jpg" alt="Jaxx Liberty Blog">
        <div class="card-body text-left p-5">
    ...
    <!-- social-->
    <div id="sec-5" class="row d-flex min-500 text-secondary m-3 shadow-lg">
    ...
    <!--download-->
    <div id="sec-2" class="row d-flex min-500 text-secondary m-3 rounded shadow-lg">
